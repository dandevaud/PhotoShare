...
namespace PhotoShare.Server.Controllers
{
	...
	public class PicturesController : ControllerBase
	{
		...
		[HttpGet($"ByGroup/{{{RouteDataConstant.GroupIdKey}}}")]
		...
		// GET: api/Pictures/5
		[HttpGet($"{{{RouteDataConstant.GroupIdKey}}}/{{pictureid}}")]
		...
		[HttpGet($"Load/{{{RouteDataConstant.GroupIdKey}}}/{{pictureid}}")]
		...
		[HttpPost($"Load/{{{RouteDataConstant.GroupIdKey}}}")]
		...
		// GET: api/Pictures/5
		[HttpGet($"HasAdminRights/{{{RouteDataConstant.GroupIdKey}}}/{{pictureid}}")]
		...
		[HttpDelete($"{{{RouteDataConstant.GroupIdKey}}}/{{pictureId}}/{{adminKey}}")]
